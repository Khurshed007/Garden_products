...
export const NotFound = ({reload}) => {
  return (
    ...
    <ModallNotFound reload = {reload} center = {true} message = {"We're sorry, the page you requested could not be found. Please go back to the homepage"} btnText={"Go Home"}/>
